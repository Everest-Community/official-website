      ...
      <div className=" w-full flex flex-col lg:flex-row px-6 lg:px-14 py-20 relative">
        <div className="w-full relative z-20">
          <p
            ...
            className="lg:text-5xl text-3xl font-CircularStd-Medium text-black lg:w-505px "
          >
          ...
          <div className="flex lg:flex-row flex-col">
            ...
            <a
              ...
              className="rounded-xl flex items-center justify-center w-auto px-5 lg:mt-0 mt-4 lg:ml-5 text-sm h-12"
            >
              <svg
                className="mr-2"
                width="16"
          ...
          <div className="flex my-4">
            ...
            <button className="rounded-xl text-00a border font-CircularStd-Regular flex items-center justify-center border-indigo-500/75 w-36 ml-5 text-sm py-3">
              ...
              >
                <path
                  d="M0.707826 0.861252C0.507784 1.10274 0.406921 1.4112 0.425639 1.72422V15.2758C0.406921 15.5888 0.507784 15.8973 0.707826 16.1388L0.753764 16.1814L8.34658 8.5886V8.41141L0.753764 0.818596L0.707826 0.861252Z"
                  className="fill-current text-22"
                />
              </svg>
              Play store
        ...
        <img
          src={Car}
          alt="car"
          className="lg:absolute lg:mt-0 mt-10 right-0 bottom-0"
          style={{ width: "795px" }}
        />
      </div>
    );
